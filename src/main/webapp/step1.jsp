    ...
    <div class="margin-x">
        ...
        <div class="flex">
            <div class="card w-75 m-b-6">
                ...
                <form action="${pageContext.request.contextPath}/simulate" method="post">
                    <div class="margin-x-1">
                        <p class="label">Mon projet</p>
                        <label>
                            <select class="minimal m-t-1" name="projectType" required>
                                ...
                                <option value="pret-voiture-neuf">Je finance mon véhicule neuf</option>
                                <option value="equipement-maison">J'équipe ma maison</option>
                            </select>
                        </label>

                        <p class="label m-t-5">Je suis</p>
                        <select class="minimal m-t-1" name="position" required>
                            <option value="salarié-secteur-prive">Salarié du secteur privé</option>
